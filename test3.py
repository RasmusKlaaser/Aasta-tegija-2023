...
class Question3(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Väiketehnika ringi on tehnikahuvilised, kelle sooviks on ehitada võistlusmasinad ja lisaks ka nendega kestvussõidu võistlustel osaleda.", bg="#2a3698", fg="yellow", font=("Impact", 50))
...
class Question5(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Kas praktikakohast võib kujuneda esimene ja kindel töökoht?", bg="#2a3698", fg="yellow", font=("Impact", 50))
        ...
        CheckVar1 = tk.IntVar()
        CheckVar2 = tk.IntVar()
        C1 = tk.Checkbutton(C, text="PIGEM JAH", bg="2a3698", font=("Impact", 50), variable=CheckVar1, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Rightanswer(), Action2()])
        C2 = tk.Checkbutton(C, text="PIGEM MITTE", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
...
class Question6(tk.Frame):
    def __init__(self, parent, controller):
        ...
        C1 = tk.Checkbutton(C, text="ÕIGE", bg="#2a3698", font=("Impact", 50), variable=CheckVar1, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Rightanswer(), Action2()])
        C2 = tk.Checkbutton(C, text="VALE,SEE MUUTUB IGA NÄDAL", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
...
class Question7(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Kas Tartu Rakenduslikus Kolledžis omandad koos tööalaste praktiliste oskustega nii kutse kui keskhariduse?", bg="#2a3698", fg="yellow", font=("Impact", 50))
...
class Question8(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Kas Tartu Rakenduslik Kolledž toetab õpilaste osalemist kutsevõistlustel.", bg="#2a3698", fg="yellow", font=("Impact", 50))
...
class Question10(tk.Frame):
    def __init__(self, parent, controller):
        ...
        C1.place(bordermode="outside", height=130, width=350, x=600, y=600)
        C2.place(bordermode="outside", height=130, width=350, x=960, y=600)
        C3.place(bordermode="outside", height=130, width=350, x=960, y=600)
...
class Question11(tk.Frame):
    def __init__(self, parent, controller):
        ...
        CheckVar1 = tk.IntVar()
        CheckVar2 = tk.IntVar()
        C1 = tk.Checkbutton(C, text="OREL", bg="#2a3698", font=("Impact", 50), variable=CheckVar1, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Rightanswer(), Action2()])
        C2 = tk.Checkbutton(C, text="OBOE", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
        C3 = tk.Checkbutton(C, text="ELEKTRIKITARR", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
...
class Question12(tk.Frame):
    def __init__(self, parent, controller):
        ...
        CheckVar1 = tk.IntVar()
        CheckVar2 = tk.IntVar()
        C1 = tk.Checkbutton(C, text="POMMIAUGUS", bg="#2a3698", font=("Impact", 50), variable=CheckVar1, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Rightanswer(), Action2()])
        C2 = tk.Checkbutton(C, text="PÕLLUL", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
        C3 = tk.Checkbutton(C, text="LABORITES", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
...
class Question13(tk.Frame):
    def __init__(self, parent, controller):
        ...
        CheckVar1 = tk.IntVar()
        CheckVar2 = tk.IntVar()
        C1 = tk.Checkbutton(C, text="E-KOOL", bg="#2a3698", font=("Impact", 50), variable=CheckVar1, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Rightanswer(), Action2()])
        C2 = tk.Checkbutton(C, text="STUUDIUM", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
        C3 = tk.Checkbutton(C, text="SISEVEEB", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
...
class Question14(tk.Frame):
    def __init__(self, parent, controller):
        ...
        CheckVar1 = tk.IntVar()
        CheckVar2 = tk.IntVar()
        C1 = tk.Checkbutton(C, text="FILM", bg="#2a3698", font=("Impact", 50), variable=CheckVar1, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Rightanswer(), Action2()])
        C2 = tk.Checkbutton(C, text="INFO-TEADUS", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
        C3 = tk.Checkbutton(C, text="INFO-TEHNOLOOGIA", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
...
class Question15(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Kas selle erialaga saab olulise eelise õpigute jätkamiseks kõrgkoolis ja võib spetsialiseeruda IT valdkonna profiks?", bg="#2a3698", fg="yellow", font=("Impact", 50))
...
class Question16(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Milline eriala on eriliselt kiiresti kasvav ja maailma tulevik?", bg="#2a3698", fg="yellow", font=("Impact", 50))
        ...
        CheckVar1 = tk.IntVar()
        CheckVar2 = tk.IntVar()
        C1 = tk.Checkbutton(C, text="TARKVARAARENDAJA", bg="#2a3698", font=("Impact", 50), variable=CheckVar1, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Rightanswer(), Action2()])
        C2 = tk.Checkbutton(C, text="VEEBIHALDUR", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
...
class Question17(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Tegu on globaalse kasvava ettevõtlusvaldkonnaga, kus heade spetsialistide järele on pidevalt suur nõudlus, mistõttu tarkvaraarendaja leiab hõlpsasti tööd ka väljaspool Eestit.", bg="#2a3698", fg="yellow", font=("Impact", 50))
...
class Question18(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Tarkvaraarendajad saavad töötada vähestes valdkondades", bg="#2a3698", fg="yellow", font=("Impact", 50))
...
class Question19(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Eesti IT-sektoris on palgatase keskmisest kõrgem ning tarkvaraarendaja töötasu alumine määr võib ületada Eesti keskmise töötasu.", bg="#2a3698", fg="yellow", font=("Impact", 50))
...
class Question20(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Kas IT-süsteemide spetsialist saab tööle IT-süsteemide spetsialistina või klienditoespetsialistina?", bg="#2a3698", fg="yellow", font=("Impact", 50))
        ...
        CheckVar1 = tk.IntVar()
        CheckVar2 = tk.IntVar()
        C1 = tk.Checkbutton(C, text="SPETSIALIST", bg="#2a3698", font=("Impact", 50), variable=CheckVar1, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Rightanswer(), Action2()])
        C2 = tk.Checkbutton(C, text="KLIENDITUGI", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
...
class Question21(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Kas tegu on ettevõttevaldkonnaga, kus spetsialistie järele on väike nõudlus?", bg="#2a3698", fg="yellow", font=("Impact", 50))
...
class Question22(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Kas IT-spetsialist haldab arvutivõrke, telefoniteenuseid ja vajadusel ehitab müüri?", bg="#2a3698", fg="yellow", font=("Impact", 50))
...
class Question23(tk.Frame):
    def __init__(self, parent, controller):
        ...
        L2 = tk.Label(C, text="Milliseid võtmeoskusi on vaja edukaks IT-spetsialisti karjääriks?", bg="#2a3698", fg="yellow", font=("Impact", 50))
        ...
        CheckVar1 = tk.IntVar()
        CheckVar2 = tk.IntVar()
        C1 = tk.Checkbutton(C, text="ERINEVATE ARVUTIKEELTE TUNDMINE", bg="#2a3698", font=("Impact", 50), variable=CheckVar1, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Rightanswer(), Action2()])
        C2 = tk.Checkbutton(C, text="INVESTEERIMINE", bg="#2a3698", font=("Impact", 50), variable=CheckVar2, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Wronganswer(), Action2()])
        C3 = tk.Checkbutton(C, text="LOOGILINE MÕTLEMINE", bg="#2a3698", font=("Impact", 50),
                            variable=CheckVar1, onvalue=1,
                            offvalue=0, height=5, width=20, command=lambda: [Rightanswer(), Action2()])
        ...
        C1.place(bordermode="outside", height=130, width=350, x=600, y=600)
        C2.place(bordermode="outside", height=130, width=350, x=960, y=600)
        C3.place(bordermode="outside", height=130, width=350, x=600, y=600)

        C.pack(fill="both", expand=True)


class Question24(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
