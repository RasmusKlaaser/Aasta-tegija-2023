...
class Dice1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        B2 = tk.Button(C, state=tk.DISABLED, text="Edasi >>>", bg="#2a3698", fg="yellow", activebackground="#3d4dd2",
                       font=("Impact", 35), command=lambda: controller.show_frame_reset(Game1))
...
class Question1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        B2 = tk.Button(C, state=tk.DISABLED, text="Edasi >>>", bg="#2a3698", fg="yellow", activebackground="#3d4dd2",
                       font=("Impact", 35), command=lambda: controller.show_frame_reset(PointSum1))
        ...
        CheckVar1 = tk.IntVar()
        CheckVar2 = tk.IntVar()
        C1 = tk.Checkbutton(C, text="Vastus 1", bg="#2a3698",font=("Impact", 50), variable=CheckVar1, onvalue=1, offvalue=0, height=5, width=20)
        C2 = tk.Checkbutton(C, text="Vastus 2", bg="#2a3698",font=("Impact", 50), variable=CheckVar2, onvalue=1, offvalue=0, height=5, width=20)
        C1.pack()
        C2.pack()
